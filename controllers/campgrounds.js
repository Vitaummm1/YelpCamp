...
const mbxGeocoding = require('@mapbox/mapbox-sdk/services/geocoding'); // TO REQUIRE GEOCODING FROM MAPBOX
const mapBoxToken = process.env.MAPBOX_TOKEN;
const geocoder = mbxGeocoding({accessToken: mapBoxToken}); //TO RUN GEOCODING
